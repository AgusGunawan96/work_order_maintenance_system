...
class ITComputerList(models.Model):
    ...
    os              = models.CharField(max_length=126, choices=ListOs.choices, null=True, blank=True)
    windows_type    = models.CharField(max_length=126, choices=ListWindowsType.choices, null=True, blank=True)
    ...
    is_office_2019  = models.BooleanField(default=False, null=True)

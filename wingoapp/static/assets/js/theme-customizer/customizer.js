...
$(document).ready(function () {
  ...
  $(".customizer-color li").on("click", function () {
    ...
    $("#color").attr(
      "href",
      "/wingoapp/static/assets/css/" + color + ".css"
    );
    ...
    function () {
      ...
      switch (type) {
        ...
        case "normal-sidebar": {
          ...
          $(".logo-wrapper")
            .find("img")
            .attr("src", "/wingoapp/static/assets/images/logo/logo.png");

...
urlpatterns = [
    ...
    path('medicalTrain/medical_train_download_daterange_accounting/', views.medical_train_download_daterange_accounting, name = 'medical_train_download_daterange_accounting'),

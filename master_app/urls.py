...
urlpatterns = [
    ...
    path('UploadMasterLowModulus/', views.UploadMasterLowModulus, name='UploadMasterLowModulus'),
    ...
    path('download_csv_masterLowModulus/', views.download_csv_masterLowModulus, name='download_csv_masterLowModulus'),

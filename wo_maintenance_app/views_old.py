...
#             # FINAL FIX: Process data dengan history_id asli tanpa format tambahan
#             for row in results:
#                 history_id = row[0]  # PENTING: history_id asli dari database
#                 tgl_his = row[1]
#                 jam_his = row[2]
#                 id_line = row[3] 
#                 id_mesin = row[4]
...
#                 # Check database checker dengan history_id asli
#                 checker_key = f"row-{history_id}"
#                 has_checker = checker_key in existing_checkers
#                 checker_info = existing_checkers.get(checker_key, {})
...
#                 # FINAL FIX: Pastikan no_pengajuan adalah history_id asli, bukan format gabungan
#                 monitoring_data.append({
#                     'history_id': history_id,  # history_id asli
#                     'prioritas': prima or '-',
#                     'waktu_pengajuan': waktu_display,
#                     'no_pengajuan': history_id,  # PENTING: history_id asli tanpa format tambahan
#                     'nomor_wo': number_wo or '-',
#                     'line_name': line_name or '-',
#                     'mesin_name': mesin_display,
#                     'deskripsi': deskripsi_perbaikan or '-',
...
#     # Debug logging
#     logger.info(f"FINAL FIX: Loaded {len(monitoring_data)} monitoring items")
#     if monitoring_data:
#         sample_ids = [item['no_pengajuan'] for item in monitoring_data[:3]]
#         logger.info(f"FINAL FIX: Sample history_ids: {sample_ids}")
...
# def ajax_monitoring_refresh_database(request):
#     """
#     Ajax refresh dengan data yang konsisten
#     """
#     if request.method != 'POST':
#         return JsonResponse({'success': False, 'error': 'Method not allowed'})
...
#             # Process dengan history_id asli
#             for row in results:
#                 history_id = row[0]  # history_id asli
#                 tgl_his = row[1]
#                 jam_his = row[2]
...
#                 # FINAL FIX: Pastikan no_pengajuan = history_id asli
#                 monitoring_data.append({
#                     'prioritas': prima or '-',
#                     'waktu_pengajuan': waktu_display,
...
#         if monitoring_data:
#             sample_ids = [item['no_pengajuan'] for item in monitoring_data[:3]]
#             logger.info(f"FINAL FIX Ajax: Sample history_ids: {sample_ids}")
...
#     """
#     Load checker data dari database (keep existing - sudah benar)
#     """
#     checker_data = {}

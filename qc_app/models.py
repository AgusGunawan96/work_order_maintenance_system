...
class rirDetailCoaContentJudgement (models.Model):
    ...
    coa_content_remark              = models.TextField(default = '-', blank=False, null=False)
    is_special_judgement            = models.BooleanField(default=False, blank = False, null = True)
    created_at                      = models.DateTimeField('created at', auto_now_add = True, null=True, blank=True)
    updated_at                      = models.DateTimeField('updated at', auto_now = True)
...
class rirDetailAppearenceJudgement (models.Model):
    ...
    appearence_remark               = models.TextField(default = '-', blank=False, null=False)
    is_special_judgement            = models.BooleanField(default=False, blank = True, null = True)
    created_at                      = models.DateTimeField('created at', auto_now_add = True, null=True, blank=True)
    updated_at                      = models.DateTimeField('updated at', auto_now = True)
...
class rirDetailRestrictedSubstanceJudgement (models.Model):
    ...
    restricted_substance_remark             = models.TextField(default = '-', blank=False, null=False)
    is_special_judgement                    = models.BooleanField(default=False, blank = True, null = True)
    created_at                              = models.DateTimeField('created at', auto_now_add = True, null=True, blank=True)
    updated_at                              = models.DateTimeField('updated at', auto_now = True)
...
class rirDetailEnvironmentalIssueJudgement (models.Model):
    ...
    environmental_issue_remark          = models.TextField(default = '-', blank=False, null=False)
    is_special_judgement                = models.BooleanField(default=False, blank = True, null = True)
    created_at                          = models.DateTimeField('created at', auto_now_add = True, null=True, blank=True)
    updated_at                          = models.DateTimeField('updated at', auto_now = True)
...
class rirDetailSampleTestJudgement (models.Model):
    ...
    sample_test_remark          = models.TextField(default = '-', blank=False, null=False)
    is_special_judgement        = models.BooleanField(default=False, blank = True, null = True)
    created_at                  = models.DateTimeField('created at', auto_now_add = True, null=True, blank=True)
    updated_at                  = models.DateTimeField('updated at', auto_now = True)
